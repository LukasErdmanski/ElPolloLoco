 ...
 * '{@link MovableObject#checkMakeMovementIntervalHandler}' and '{@link MovableObject#checkMakeMovementIntervalHandler}' methods.
 * @abstract
 * @class
...
class MovableObject extends DrawableObject {
  ...
  /**
   * Speed and acceleration during jump / falling down.
   * @type {number}
   */
  speedY = 0;

  /**
   * Acceleration during jump / falling down.
   * @type {number}
   */
  acceleration = 1;

  /**
   * Determines if the object can turn around.
   * @type {boolean}
   */
  canTurnAround = false;

  /**
   * Determines if the object is moving in the other direction.
   * @type {boolean}
   */
  otherDirection = false;

  /**
   * The high counter of the iteration through the given 'images' array in the animate() function.
   * @type {number}
   */
  currentImgIdx = 0;

  /**
   * The current set of images used for animation.
   * @type {Array<Image>}
   */
  currentImagesSet;

  /**
   * Health of the movable object.
   * @type {number}
   */
  health = 5;

  /**
   * Initial health of the movable object.
   * @type {number}
   */
  healthInitial = this.health;

  /**
   * Percentage of the current health.
   * @type {number}
   */
  ...
  /**
   * Reference to the level the object is in.
   * @type {Object}
   */
  level;
   ...
   * This function relies on the implementation of abstract methods '{@link MovableObject#checkMakeMovementIntervalHandler}' and
   * '{@link MovableObject#checkSetImagesIntervalHandler}' provided by subclasses.
